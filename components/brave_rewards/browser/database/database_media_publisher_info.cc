...
DatabaseMediaPublisherInfo::DatabaseMediaPublisherInfo(int current_db_version) :
    DatabaseTable(current_db_version) {
}

DatabaseMediaPublisherInfo::~DatabaseMediaPublisherInfo() = default;

bool DatabaseMediaPublisherInfo::Init(
    sql::Database* db) {
...
bool DatabaseMediaPublisherInfo::CreateTable(
    sql::Database* db) {
...
bool DatabaseMediaPublisherInfo::CreateIndex(
    sql::Database* db) {
...
base::flat_map<std::string, std::string> DatabaseMediaPublisherInfo::GetRecord(
    sql::Database* db,
