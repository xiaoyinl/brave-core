...
TEST_F(PublisherInfoDatabaseTest, InsertContributionInfo) {
  ...
  info.year = 1970;
  info.type = ledger::REWARDS_TYPE::AUTO_CONTRIBUTE;
...
TEST_F(PublisherInfoDatabaseTest, InsertPendingContribution) {
  ...
  contribution1->type = ledger::REWARDS_TYPE::AUTO_CONTRIBUTE;
  ...
  contribution2->type = ledger::REWARDS_TYPE::ONE_TIME_TIP;
...
void PublisherInfoDatabaseTest::PreparePendingContributions() {
  ...
  contribution3->type = ledger::REWARDS_TYPE::ONE_TIME_TIP;
  ...
  contribution4->type = ledger::REWARDS_TYPE::ONE_TIME_TIP;
