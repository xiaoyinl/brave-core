...
#include "brave/components/brave_webcompat_reporter/resources/grit/brave_webcompat_reporter_generated_map.h"
...
BraveWebcompatReporterUI::BraveWebcompatReporterUI(content::WebUI* web_ui, const std::string& name)
  ...
  content::WebUIDataSource* data_source = CreateBasicUIHTMLSource(profile,
                                                  name,
                                                  kBraveWebcompatReporterGenerated,
                                                  kBraveWebcompatReporterGeneratedSize,
                                                  IDR_BRAVE_WEBCOMPAT_REPORTER_HTML);
