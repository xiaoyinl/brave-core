...
void NativeLedgerClient::OnReconcileComplete(ledger::Result result, const std::string & viewing_id, const std::string & probi, ledger::RewardsCategory category) {
  [bridge_ onReconcileComplete:result viewingId:viewing_id probi:probi category:category];
}
